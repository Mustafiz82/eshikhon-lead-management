...
const LeadModals = ({ selectedLead, setSelectedLead, statusOptions, refetch, course }) => {
    ...
    const searchSuggestions = searchInput?.trim() && isDropdownOpen
        ? course.filter(item => item.name.toLowerCase().includes(searchInput.toLowerCase()))
        : [];
        ...
        selectedLead && <div className="fixed inset-0 !z-9999 bg-black/40 flex items-center justify-center">
            ...
            <div className={`bg-base-100 w-full scale-90    rounded-lg shadow-lg p-6 relative grid grid-cols-1 ${(modelStatus == "Enrolled" || modelStatus == "Refunded" || modelStatus == "Enrolled with Other Number") ? "md:grid-cols-2 lg:grid-cols-4 max-w-7xl" : "md:grid-cols-3 lg:grid-cols-3 max-w-5xl"} gap-4 max-h-[90vh] overflow-y-visible`}>
                ...
                <div className="space-y-6 max-h-[450px] [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]  overflow-y-scroll">
                    ...
                    {/* SECTION: COURSE INFO */}
                    <div>
                        <h4 className="text-xs font-bold text-white/80 mb-1">Course Info</h4>
                        <div className="grid grid-cols-[130px_1fr] gap-y-1 text-sm">
                ...
                <div className="flex flex-col gap-2 ">
                    ...
                    <div className="flex mt-2 gap-2 justify-center ">
                        ...
                        <div className="space-y-2 flex-2">
                            ...
                            >
                                <Image alt="Linphone" src={"/logo/linphone.jpg"} className="w-auto h-5 " width={1000} height={1000} />  Call on Linphone
                            </a>
                    ...
                    <div className="relative mt-2 w-full">
                        <div className="dropdown   w-full">
                            ...
                            >
                                {statusOptions.filter(item => ((item != "All") && (item != "Contacted"))).map((s) => (
                                    <li key={s}>
                                        <button
                                            onClick={() => {
                                                setModelStatus(s)

...
const AgentAllLeads = () => {
    ...
    return (
        /* FIX 1: Removed 'overflow-hidden' from main wrapper to allow proper layout overflow */
        <div className="p-6 mx-auto min-h-[calc(100vh-100px)] xl:min-h-screen relative">
            {/* Filters */}
            <div
            ...
            >
                ...
                {/* Search */}
                <div className="flex fixed xl:static top-7 z-50 right-[25%] md:right-24 items-center gap-2">
                    <button onClick={() => setSearchModalOpen(true)} className="flex cursor-pointer items-center gap-2">
            ...
            {!loading && (
                <>
                    {/* FIX 2: Added overflow-x-auto to cleanly confine horizontal scrolling to the table */}
                    <div className="mt-10 xl:mt-0 overflow-x-auto w-full">
                        <LeadTable
                            leads={leads}
                    ...
                    <div className="flex flex-col justify-between mt-6">
                        ...
                        <div className="flex items-center gap-4 flex-wrap">
                            ...
                            <div className="flex justify-between w-full items-center gap-5">
                                <p className="text-sm flex-1 text-nowrap">
                                    Showing {leadCountStart}–{leadCountEnd} of {totalLeads} results
                                </p>

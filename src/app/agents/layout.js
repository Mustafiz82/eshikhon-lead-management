          ...
          <div className="drawer-content h-full">
            <div className="flex bg-gray-900 fixed z-9999 w-full  xl:hidden p-5 top-0 h-fit justify-between items-center">
              <a href="https://eshikhon.com/" target="blank">
                <img className="h-10" src={"/logo/eshikhon.svg"} />
              </a>
              <label
                htmlFor="my-drawer"
                className="btn btn-primary bg-blue-600 text-xl drawer-button"
              >
                <LuMenu />
              </label>
            </div>
            <div className="mt-16 xl:ml-10 2xl:ml-0 xl:mt-0">{children}</div>
          </div>
          <div
            className={`${isSmall && "drawer-side"} max-h-screen sticky top-0  z-8999! p-0`}
          >
            ...
            <ul className="menu flex-nowrap shrink-0 p-0 pt-8  bg-gray-800 gap-3 w-80   text-gray-100 min-h-full overflow-hidden xl:w-12 fixed 2xl:static hover:w-80 duration-300  ">
              ...
              <Link href={"/agents/payments"}>
                <li className="flex flex-nowrap text-nowrap shrink-0 cursor-pointer px-5 flex-row items-center gap-2 text-md   py-3 rounded-none   hover:bg-blue-900 hover:text-white transition">
                  <MdPayments  className="text-xl  shrink-0 p-0" /> Payments
                </li>
              </Link>
              ...
              <div className="flex mt-2  px-5 justify-start">
                <a href="https://eshikhon.com/" target="blank">
                  <img className="h-12  " src={"/logo/eshikhon.svg"} />
                </a>
              </div>
            </ul>
          </div>
